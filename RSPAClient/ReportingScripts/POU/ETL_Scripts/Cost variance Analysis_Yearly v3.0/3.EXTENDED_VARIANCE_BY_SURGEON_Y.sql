...
--BY YEAR
DELETE FROM MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y
...
-----------------------
--SELECT * FROM MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y  WHERE ICD_CODE=' '
---- DELETE FROM MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y WHERE ICD_CODE=' '
--SELECT * FROM MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y  WHERE ICD_DESCR=' ' --2590

--UPDATE MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y
--SET [PROCEDURE_CODE] = [Item_details].PROCEDURE_CODE,
--ICD_DESCR = ISNULL([Item_details].proc_descr,' '),
--PROCEDURE_DESCRIPTION = ISNULL([Item_details].proc_descr,' ')
--FROM MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y,[Item_details]
--WHERE MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y.ICD_CODE = [Item_details].PROCEDURE_CODE
------------------------------------------------------------------------------------------------
...
--SELECT SERVICE_CODE, PROCEDURE_CODE, PHYSICIAN, CASEID,[POU ITEM], (([TOTALCASEPICKQTY] + [TOTAL IN ROOM QTY]) - (([TOTALRETURNED] + [TOTAL WASTED]))) QTY,[CURRENTITEMCOST],
--	 ((([TOTALCASEPICKQTY] + [TOTAL IN ROOM QTY]) - (([TOTALRETURNED] + [TOTAL WASTED]))) * [CURRENTITEMCOST]) TOTAL_SPEND, 
--			 DATEPART(YYYY,[performdatewtime]) [YEAR] 
--			 FROM [Item_details]
			 --WHERE PROCEDURE_CODE='C79.89' AND SERVICE_CODE='ORTHOPEDICS' ORDER BY [CURRENTITEMCOST] DESC 
--select count(PROCEDURE_CODE) PROCEDURE_COUNT,SERVICE_CODE, PHYSICIAN, PROCEDURE_CODE from TEMP_PHYSICIAN_AVERAGE_TAB3_Y_PROC 
--group by SERVICE_CODE, PHYSICIAN, PROCEDURE_CODE having count(PROCEDURE_CODE)>1 order by PROCEDURE_CODE

--select  distinct(PROCEDURE_CODE) from TEMP_PHYSICIAN_AVERAGE_TAB3_Y_PROC 
--group by SERVICE_CODE, PHYSICIAN, PROCEDURE_CODE 
--select distinct(PROCEDURE_CODE) FROM [Item_details] order by PROCEDURE_CODE
...
update MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y set SPECIALTY_CODE='OTHERS' where SPECIALTY_CODE=''

update MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y set DIAGNOSIS_DESCRIPTION=DIAGNOSIS_CODE where DIAGNOSIS_DESCRIPTION=''

--select top 100 * from [MT_POU_RPT_OPT_BY_PHYSICIAN_Y]
...
update MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y set DIAGNOSIS_DESCRIPTION=[DIAGNOSIS_CODE] where DIAGNOSIS_DESCRIPTION=''
...
--select * from MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y where DIAGNOSIS_CODE_TYPE=3


update MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y set SPECIALTY_CODE='OTHERS' where SPECIALTY_CODE=''
--update MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y set SPECIALTY_DESCRIPTION=SPECIALTY_CODE where SPECIALTY_DESCRIPTION=''

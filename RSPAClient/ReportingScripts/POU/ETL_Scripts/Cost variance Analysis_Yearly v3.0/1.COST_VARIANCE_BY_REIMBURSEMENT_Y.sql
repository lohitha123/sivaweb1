...
--WHERE MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_M.ICD_CODE = [Item_details].PROCEDURE_CODE
...
--WHERE MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Q.ICD_CODE = [Item_details].PROCEDURE_CODE
...
--WHERE MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_H.ICD_CODE = [Item_details].PROCEDURE_CODE

--SELECT * FROM MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y WHERE ICD_DESCR=' ' --1730

--UPDATE MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y
--SET [PROCEDURE_CODE] = [Item_details].PROCEDURE_CODE,
--ICD_DESCR = ISNULL([Item_details].proc_descr,' '),
--PROCEDURE_DESCRIPTION = ISNULL([Item_details].proc_descr,' ')
--FROM MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y,[Item_details]
--WHERE MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y.ICD_CODE = [Item_details].PROCEDURE_CODE

--SELECT PROCEDURE_CODE,proc_descr,* FROM [Item_details] WHERE PROCEDURE_CODE='K8042'
...
--PROCEDURE_ID, PC_DESCRIPTION

--select * from MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y where [DIAGNOSIS_CODE_TYPE]=3

--select * from [MT_POU_RPT_OPT_BY_PROCEDURE_Y] where PROCEDURE_CODE = 'CTAAAAVR'

--select * from ATPAR_MT.MT_POU_PROCEDURE_CODE where PROCEDURE_CODE = 'CTAAAAVR'
...
--SELECT *  FROM TEMP_PHYSICIAN_AVERAGE_TAB2_Y_PROC
--WHERE SERVICE_CODE = 'ORTHOPEDICS' AND PROCEDURE_CODE='M23.221'

--658554.55

update MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y set SPECIALTY_CODE='OTHERS' where SPECIALTY_CODE=''
update MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y set SPECIALTY_DESCRIPTION=SPECIALTY_CODE where SPECIALTY_DESCRIPTION=''



--SELECT proc_descr,PROCEDURE_CODE FROM TEMP_PHYSICIAN_AVERAGE_TAB2_Y_PROC WHERE (proc_descr IS NULL OR proc_descr='' OR proc_descr=' ')

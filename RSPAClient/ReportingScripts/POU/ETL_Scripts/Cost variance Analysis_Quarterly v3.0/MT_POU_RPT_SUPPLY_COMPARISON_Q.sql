...
-- BY QUARTER
SELECT *  FROM MT_POU_RPT_SUPPLY_COMPARISON_Q WHERE [DIAGNOSIS_CODE_TYPE]=1
	-- DELETE FROM MT_POU_RPT_SUPPLY_COMPARISON_Q WHERE [DIAGNOSIS_CODE_TYPE]=1(297404)
INSERT INTO MT_POU_RPT_SUPPLY_COMPARISON_Q
 ([SPECIALTY_CODE]
,[DIAGNOSIS_CODE]
...
UPDATE MT_POU_RPT_SUPPLY_COMPARISON_Q SET [PHYSICIAN_NAME]=ISNULL([Item_details].SURGE_DESCIPTION_orig,'') 
FROM MT_POU_RPT_SUPPLY_COMPARISON_Q,[Item_details]
WHERE MT_POU_RPT_SUPPLY_COMPARISON_Q.PHYSICIAN_ID=[Item_details].PHYSICIAN
...
-- BY QUARTER
select * from MT_POU_RPT_SUPPLY_COMPARISON_Q
	-- DELETE FROM MT_POU_RPT_SUPPLY_COMPARISON_Q (297404)
INSERT INTO MT_POU_RPT_SUPPLY_COMPARISON_Q
 ([SPECIALTY_CODE]
,[DIAGNOSIS_CODE]
,[DIAGNOSIS_DESCRIPTION]
...
--AND ICD10 IS NOT NULL
--AND SERVICE_CODE = 'UROLOGY' AND ICD10 = 'Z43.6' AND PHYSICIAN = 'KOGAN' AND [POU ITEM] = '10884521007819'
GROUP BY SERVICE_CODE, PROCEDURE_CODE,[proc_descr], PHYSICIAN, [Group], [POU ITEM], [POU DESCRIPTION], [MHS MFGID], DATEPART(YYYY,[performdatewtime]), DATEPART(Q,[performdatewtime])
ORDER BY [POU ITEM]

UPDATE MT_POU_RPT_SUPPLY_COMPARISON_Q SET [PHYSICIAN_NAME]=ISNULL([Item_details].SURGE_DESCIPTION_orig,'') FROM MT_POU_RPT_SUPPLY_COMPARISON_Q,[Item_details]
WHERE MT_POU_RPT_SUPPLY_COMPARISON_Q.PHYSICIAN_ID=[Item_details].PHYSICIAN
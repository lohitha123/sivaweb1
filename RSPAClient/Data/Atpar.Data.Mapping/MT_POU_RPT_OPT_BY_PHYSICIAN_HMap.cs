...
{
    public class MT_POU_RPT_OPT_BY_PHYSICIAN_HMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PHYSICIAN_H>
    {
        public MT_POU_RPT_OPT_BY_PHYSICIAN_HMap()
        {
            // Primary Key
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PHYSICIAN_H", "ATPAR_MT_AJAYWEB");

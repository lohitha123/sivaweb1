...
{
    public class MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_YMap : EntityTypeConfiguration<MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y>
    {
        public MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_YMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE, t.PHYSICIAN_ID, t.DIAGNOSIS_CODE_TYPE, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_Y", "ATPAR_MT_AJAYWEB");

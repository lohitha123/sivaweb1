...
{
    public class MT_RPT_FIELDS_LISTMap : EntityTypeConfiguration<MT_RPT_FIELDS_LIST>
    {
        public MT_RPT_FIELDS_LISTMap()
        {
            // Primary Key
            ...
            this.ToTable("MT_RPT_FIELDS_LIST", "ATPAR_MT_AJAYWEB");

...
{
    public class MT_POU_RPT_OPT_BY_PREFERENCE_YMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PREFERENCE_Y>
    {
        public MT_POU_RPT_OPT_BY_PREFERENCE_YMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.PROCEDURE_CODE, t.PREF_LIST_ID, t.PHYSICIAN_ID, t.ITEM_ID, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PREFERENCE_Y", "ATPAR_MT_AJAYWEB");

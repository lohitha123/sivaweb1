...
{
    public class MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_HMap : EntityTypeConfiguration<MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_H>
    {
        public MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_HMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE_TYPE, t.PERIOD, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_H", "ATPAR_MT_AJAYWEB");

...
{
    public class MT_POU_RPT_OPT_BY_PROCEDURE_MMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PROCEDURE_M>
    {
        public MT_POU_RPT_OPT_BY_PROCEDURE_MMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.PROCEDURE_CODE, t.MONTH, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PROCEDURE_M", "ATPAR_MT_AJAYWEB");

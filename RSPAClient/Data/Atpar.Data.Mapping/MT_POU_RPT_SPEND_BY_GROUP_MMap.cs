...
{
    public class MT_POU_RPT_SPEND_BY_GROUP_MMap : EntityTypeConfiguration<MT_POU_RPT_SPEND_BY_GROUP_M>
    {
        public MT_POU_RPT_SPEND_BY_GROUP_MMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE, t.DIAGNOSIS_CODE_TYPE, t.PHYSICIAN_ID, t.ITEM_GROUP, t.MONTH, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_SPEND_BY_GROUP_M", "ATPAR_MT_AJAYWEB");

...
{
    public class MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_MMap : EntityTypeConfiguration<MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_M>
    {
        public MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_MMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE, t.PHYSICIAN_ID, t.DIAGNOSIS_CODE_TYPE, t.MONTH, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_EXTENDED_VARIANCE_BY_SURGEON_M", "ATPAR_MT_AJAYWEB");

...
{
    public class MT_POU_RPT_OPT_BY_PHYSICIAN_YMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PHYSICIAN_Y>
    {
        public MT_POU_RPT_OPT_BY_PHYSICIAN_YMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.PROCEDURE_CODE, t.PHYSICIAN_ID, t.PREF_LIST_ID, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PHYSICIAN_Y", "ATPAR_MT_AJAYWEB");

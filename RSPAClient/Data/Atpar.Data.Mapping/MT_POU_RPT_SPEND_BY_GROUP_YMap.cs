...
{
    public class MT_POU_RPT_SPEND_BY_GROUP_YMap : EntityTypeConfiguration<MT_POU_RPT_SPEND_BY_GROUP_Y>
    {
        public MT_POU_RPT_SPEND_BY_GROUP_YMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE, t.DIAGNOSIS_CODE_TYPE, t.PHYSICIAN_ID, t.ITEM_GROUP, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_SPEND_BY_GROUP_Y", "ATPAR_MT_AJAYWEB");

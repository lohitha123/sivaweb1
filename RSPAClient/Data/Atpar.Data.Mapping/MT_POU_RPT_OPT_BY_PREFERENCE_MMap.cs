...
{
    public class MT_POU_RPT_OPT_BY_PREFERENCE_MMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PREFERENCE_M>
    {
        public MT_POU_RPT_OPT_BY_PREFERENCE_MMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.PROCEDURE_CODE, t.PREF_LIST_ID, t.PHYSICIAN_ID, t.ITEM_ID, t.MONTH, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PREFERENCE_M", "ATPAR_MT_AJAYWEB");

...
{
    public class MT_POU_RPT_OPT_BY_PROCEDURE_YMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PROCEDURE_Y>
    {
        public MT_POU_RPT_OPT_BY_PROCEDURE_YMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.PROCEDURE_CODE, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PROCEDURE_Y", "ATPAR_MT_AJAYWEB");

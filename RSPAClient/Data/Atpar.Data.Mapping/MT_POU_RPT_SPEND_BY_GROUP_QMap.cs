...
{
    public class MT_POU_RPT_SPEND_BY_GROUP_QMap : EntityTypeConfiguration<MT_POU_RPT_SPEND_BY_GROUP_Q>
    {
        public MT_POU_RPT_SPEND_BY_GROUP_QMap()
        {
            // Primary Key
            ...
            this.ToTable("MT_POU_RPT_SPEND_BY_GROUP_Q", "ATPAR_MT_AJAYWEB");

...
{
    public class MT_POU_RPT_OPT_BY_PROCEDURE_HMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PROCEDURE_H>
    {
        public MT_POU_RPT_OPT_BY_PROCEDURE_HMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.PROCEDURE_CODE, t.PERIOD, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PROCEDURE_H", "ATPAR_MT_AJAYWEB");

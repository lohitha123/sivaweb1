...
{
    public class MT_POU_RPT_OPT_BY_PHYSICIAN_MMap : EntityTypeConfiguration<MT_POU_RPT_OPT_BY_PHYSICIAN_M>
    {
        public MT_POU_RPT_OPT_BY_PHYSICIAN_MMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.PROCEDURE_CODE, t.PHYSICIAN_ID, t.PREF_LIST_ID, t.MONTH, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_OPT_BY_PHYSICIAN_M", "ATPAR_MT_AJAYWEB");

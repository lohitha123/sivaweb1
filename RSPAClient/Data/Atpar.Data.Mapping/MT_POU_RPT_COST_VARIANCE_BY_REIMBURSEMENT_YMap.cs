...
{
    public class MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_YMap : EntityTypeConfiguration<MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y>
    {
        public MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_YMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE, t.DIAGNOSIS_CODE_TYPE, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_COST_VARIANCE_BY_REIMBURSEMENT_Y", "ATPAR_MT_AJAYWEB");

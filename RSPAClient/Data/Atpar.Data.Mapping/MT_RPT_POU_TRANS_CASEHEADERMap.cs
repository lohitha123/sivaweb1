...
{
    public class MT_RPT_POU_TRANS_CASEHEADERMap : EntityTypeConfiguration<MT_RPT_POU_TRANS_CASEHEADER>
    {
        public MT_RPT_POU_TRANS_CASEHEADERMap()
        {
            // Primary Key
            this.HasKey(t => new { t.CASE_ID, t.PREF_LIST_ID, t.ROOM_NO, t.PROCEDURE_CODE, t.EMERGENCY_CASE, t.TRANSACTION_ID, t.APP_ID });
            ...
            this.ToTable("MT_RPT_POU_TRANS_CASEHEADER", "ATPAR_MT_AJAYWEB");
            ...
            this.Property(t => t.CCH_STATUS).HasColumnName("CCH_STATUS");
            ...
            this.Property(t => t.ENCOUNTER_ID).HasColumnName("ENCOUNTER_ID");

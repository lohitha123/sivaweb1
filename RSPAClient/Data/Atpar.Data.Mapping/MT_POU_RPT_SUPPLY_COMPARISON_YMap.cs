...
{
    public class MT_POU_RPT_SUPPLY_COMPARISON_YMap : EntityTypeConfiguration<MT_POU_RPT_SUPPLY_COMPARISON_Y>
    {
        public MT_POU_RPT_SUPPLY_COMPARISON_YMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE, t.DIAGNOSIS_CODE_TYPE, t.PHYSICIAN_ID, t.ITEM_GROUP, t.ITEM_ID, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_SUPPLY_COMPARISON_Y", "ATPAR_MT_AJAYWEB");

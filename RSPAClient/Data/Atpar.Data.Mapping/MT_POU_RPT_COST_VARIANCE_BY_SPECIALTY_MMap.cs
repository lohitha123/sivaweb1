...
{
    public class MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_MMap : EntityTypeConfiguration<MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_M>
    {
        public MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_MMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SPECIALTY_CODE, t.DIAGNOSIS_CODE_TYPE, t.MONTH, t.YEAR });
            ...
            this.ToTable("MT_POU_RPT_COST_VARIANCE_BY_SPECIALTY_M", "ATPAR_MT_AJAYWEB");

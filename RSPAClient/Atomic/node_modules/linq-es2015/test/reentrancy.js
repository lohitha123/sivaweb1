...
describe('Reentrancy -', function () {
    it('ChunkBy()', function () {
        let iterable = linq_1.asEnumerable(data_1.phrase).ChunkBy(o => o.key, o => o.value);
    ...
    it('Select()', function () {
        var iterable = linq_1.asEnumerable(data_1.jsn).Select((a) => a.name);
        var iterator = iterable[Symbol.iterator]();
    ...
    it('Distinct()', function () {
        ...
        let iterable = linq_1.asEnumerable(test).Distinct(o => o.id);
    ...
    it('Where()', function () {
        let iterable = linq_1.asEnumerable(data_1.simpleArray).Where(a => a % 2 == 1);
        let iterator = iterable[Symbol.iterator]();
        chai_1.assert.equal(1, iterator.next().value);
    ...
    it('Skip()', function () {
        let iterable = linq_1.asEnumerable(data_1.simpleArray).Skip(7);
        let iterator = iterable[Symbol.iterator]();
    ...
    it('Join()', function () {
        var iterable = linq_1.asEnumerable(data_1.people).Join(data_1.pets, person => person, pet => pet.Owner, (person, pet) => {
    ...
    it('GroupJoin()', function () {
        var iterable = linq_1.asEnumerable(data_1.people)
            .GroupJoin(data_1.pets, person => person, pet => pet.Owner, (person, petCollection) => {
            return {
                Owner: person.Name,
                Pets: linq_1.asEnumerable(petCollection)
                    .Select(pet => pet.Name)
                    .ToArray()
            };
        });
    ...
    it('GroupBy()', function () {
        var iterable = linq_1.asEnumerable(data_1.pets).GroupBy(pet => pet.Age);
        var iterator = iterable[Symbol.iterator]();
        var result = iterator.next().value;
    ...
    it('SelectMany()', function () {
        var iterable = linq_1.asEnumerable(data_1.jsn).SelectMany(a => a.ids);
        var iterator = iterable[Symbol.iterator]();

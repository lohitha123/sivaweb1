...
var AccessPermissionComponent = (function () {
    function AccessPermissionComponent(dataservice) {
    ...
    AccessPermissionComponent.prototype.go = function () {
        var _this = this;
        this.table = !this.table;
        this.dataservice.getAMaccessPer().then(function (countries) { _this.sales = countries; });
    };

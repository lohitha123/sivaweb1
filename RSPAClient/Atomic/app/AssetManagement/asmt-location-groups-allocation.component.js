...
var LocationGroupsAllocationComponent = (function () {
    function LocationGroupsAllocationComponent(dataservice) {
    ...
    LocationGroupsAllocationComponent.prototype.go = function () {
        var _this = this;
        this.table = !this.table;
        this.dataservice.getAMallocateGrp().then(function (countries) { _this.sales = countries; });
    };
...
//# sourceMappingURL=asmt-location-groups-allocation.component.js.map
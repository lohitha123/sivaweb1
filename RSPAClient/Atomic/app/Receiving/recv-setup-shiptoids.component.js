...
var SetupShipToIdsComponent = (function () {
    function SetupShipToIdsComponent(dataservice) {
    ...
    SetupShipToIdsComponent.prototype.go = function () {
        var _this = this;
        this.dataservice.getrecSetupShiptoids().then(function (countries) { _this.sales = countries; });
        this.pop = !this.pop;
    };
    SetupShipToIdsComponent.prototype.add = function () {
        this.form = true;
        this.editform = false;
        this.page = false;
        this.pop = false;
    };
    SetupShipToIdsComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    SetupShipToIdsComponent.prototype.close = function () {
        this.form = false;
        this.page = true;
        this.pop = true;
        this.editform = false;
...
SetupShipToIdsComponent = __decorate([
    core_1.Component({
        templateUrl: './app/Receiving/recv-setup-shiptoids.component.html',

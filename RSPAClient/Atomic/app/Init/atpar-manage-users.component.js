...
var ManageUsersComponent = (function () {
    function ManageUsersComponent(dataservice) {
    ...
    ManageUsersComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getmanageUser().then(function (countries) { _this.sales = countries; });
    };
    ManageUsersComponent.prototype.edit = function () {
        this.editpage = !this.editpage;
        this.page = false;
    };
    ManageUsersComponent.prototype.back = function () {
        this.page = true;
        this.editpage = false;
    };
...
//# sourceMappingURL=atpar-manage-users.component.js.map
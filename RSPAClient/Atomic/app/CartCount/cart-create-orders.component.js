...
var CreateOrdersComponent = (function () {
    function CreateOrdersComponent(dataservice) {
    ...
    CreateOrdersComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getcreateOrder().then(function (countries) { _this.sales = countries; });
    };

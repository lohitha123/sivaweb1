...
var ProcessParametersComponent = (function () {
    function ProcessParametersComponent(dataservice) {
    ...
    ProcessParametersComponent.prototype.go = function () {
        ...
        this.dataservice.getprocessParam().then(function (countries) { _this.sales = countries; });
    };
    return ProcessParametersComponent;
}());
ProcessParametersComponent = __decorate([
    core_1.Component({
        templateUrl: './app/CartCount/cart-process-parameters.component.html',

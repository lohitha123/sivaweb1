...
var AllocatePickingZonesComponent = (function () {
    function AllocatePickingZonesComponent(dataservice) {
    ...
    AllocatePickingZonesComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getpickAllocPackingZone().then(function (countries) { _this.sales = countries; });
    };
    AllocatePickingZonesComponent.prototype.add = function () {
        this.page = false;
        this.pop = false;
        this.table = true;
    };
    AllocatePickingZonesComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    AllocatePickingZonesComponent.prototype.close = function () {
        var _this = this;
        this.page = true;
        this.pop = true;
        this.table = false;
    ...
    AllocatePickingZonesComponent.prototype.onfocusToCalendar = function (e) {
        this.date2 = null;
        if (this.date1 == null) {
    ...
    AllocatePickingZonesComponent.prototype.onfocusFromCalendar = function (e) {
...
AllocatePickingZonesComponent = __decorate([
    core_1.Component({
        templateUrl: './app/Pick/pick-allocate-picking-zones.component.html',

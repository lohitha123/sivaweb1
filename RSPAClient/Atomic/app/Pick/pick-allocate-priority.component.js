...
var AllocatePriorityComponent = (function () {
    function AllocatePriorityComponent(dataservice) {
    ...
    AllocatePriorityComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getallocatePriority().then(function (countries) { _this.sales = countries; });
    };
    AllocatePriorityComponent.prototype.add = function () {
        this.page = false;
        this.pop = false;
        this.table = true;
    };
    AllocatePriorityComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    AllocatePriorityComponent.prototype.close = function () {
        var _this = this;
        this.page = true;
        this.pop = true;
        this.table = false;
    ...
    AllocatePriorityComponent.prototype.onfocusToCalendar = function (e) {
        this.date2 = null;
        if (this.date1 == null) {
    ...
    AllocatePriorityComponent.prototype.onfocusFromCalendar = function (e) {
...
AllocatePriorityComponent = __decorate([
    core_1.Component({
        templateUrl: './app/Pick/pick-allocate-priority.component.html',

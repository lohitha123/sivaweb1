...
var LeftbarccComponent = (function () {
    function LeftbarccComponent(leftBarAnimationService) {
        this.leftBarAnimationService = leftBarAnimationService;
        this.isActive = false;
        this.showStyle = true;
    }
    LeftbarccComponent.prototype.getDisplay = function () {
        this.activeMenu = this.leftBarAnimationService.get();
        return this.leftBarAnimationService.get();
    };
    return LeftbarccComponent;
}());
LeftbarccComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.LeftbarccComponent = LeftbarccComponent;
//# sourceMappingURL=leftbarcc.component.js.map
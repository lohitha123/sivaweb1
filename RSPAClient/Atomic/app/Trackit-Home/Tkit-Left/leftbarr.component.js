...
var LeftbarrComponent = (function () {
    function LeftbarrComponent(leftBarAnimationService) {
        this.leftBarAnimationService = leftBarAnimationService;
        this.isActive = false;
        this.showStyle = true;
    }
    LeftbarrComponent.prototype.getDisplay = function () {
        this.activeMenu = this.leftBarAnimationService.get();
        return this.leftBarAnimationService.get();
    };
    return LeftbarrComponent;
}());
LeftbarrComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.LeftbarrComponent = LeftbarrComponent;
//# sourceMappingURL=leftbarr.component.js.map
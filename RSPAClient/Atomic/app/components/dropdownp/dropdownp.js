...
var ObjectUtils_1 = require("../common/utils/ObjectUtils");
var forms_1 = require("@angular/forms");
exports.DROPDOWN_VALUE_ACCESSOR = {
    provide: forms_1.NG_VALUE_ACCESSOR,
    useExisting: core_1.forwardRef(function () { return Dropdownp; }),
    multi: true
};
var Dropdownp = (function () {
    function Dropdownp(el, domHandler, renderer, differs, cd, objectUtils) {
        this.el = el;
    ...
    Dropdownp.prototype.ngAfterContentInit = function () {
        var _this = this;
    ...
    Dropdownp.prototype.ngOnInit = function () {
        this.optionsToDisplay = this.options;
        this.updateSelectedOption(null);
    };
    Dropdownp.prototype.ngDoCheck = function () {
    ...
    Dropdownp.prototype.ngAfterViewInit = function () {
    ...
    Object.defineProperty(Dropdownp.prototype, "label", {
        get: function () {
    ...
    Object.defineProperty(Dropdownp.prototype, "editableLabel", {
        get: function () {
    ...
    Dropdownp.prototype.onItemClick = function (event, option) {
        this.itemClick = true;
        this.selectItem(event, option);
        this.hide();
    };
    Dropdownp.prototype.selectItem = function (event, option) {
    ...
    Dropdownp.prototype.ngAfterViewChecked = function () {
    ...
    Dropdownp.prototype.writeValue = function (value) {
        this.value = value;
        this.updateSelectedOption(value);
        this.cd.markForCheck();
    };
    Dropdownp.prototype.updateSelectedOption = function (val) {
    ...
    Dropdownp.prototype.registerOnChange = function (fn) {
        this.onModelChange = fn;
    };
    Dropdownp.prototype.registerOnTouched = function (fn) {
        this.onModelTouched = fn;
    };
    Dropdownp.prototype.setDisabledState = function (val) {
        this.disabled = val;
    };
    Dropdownp.prototype.updateDimensions = function () {
        if (this.autoWidth) {
    ...
    Dropdownp.prototype.onMouseclick = function (event, input) {
        var _this = this;
    ...
    Dropdownp.prototype.onEditableInputClick = function (event) {
        this.itemClick = true;
        this.bindDocumentClickListener();
    };
    Dropdownp.prototype.onEditableInputFocus = function (event) {
        this.focus = true;
        this.hide();
    };
    Dropdownp.prototype.onEditableInputChange = function (event) {
    ...
    Dropdownp.prototype.show = function (panel, container) {
    ...
    Dropdownp.prototype.hide = function () {
        this.panelVisible = false;
    };
    Dropdownp.prototype.onInputFocus = function (event) {
        this.focus = true;
        this.onFocus.emit(event);
    };
    Dropdownp.prototype.onInputBlur = function (event) {
        this.focus = false;
        this.onModelTouched();
        this.onBlur.emit(event);
    };
    Dropdownp.prototype.onKeydown = function (event) {
        if (this.readonly) {
            return;
        }
    ...
    Dropdownp.prototype.findListItem = function (element) {
    ...
    Dropdownp.prototype.findOptionIndex = function (val, opts) {
        var index = -1;
        if (opts) {
    ...
    Dropdownp.prototype.findOption = function (val, opts) {
        var index = this.findOptionIndex(val, opts);
        return (index != -1) ? opts[index] : null;
    };
    Dropdownp.prototype.onFilter = function (event) {
        if (this.options && this.options.length) {
    ...
    Dropdownp.prototype.applyFocus = function () {
        if (this.editable)
            this.domHandler.findSingle(this.el.nativeElement, '.ui-dropdown-label.ui-inputtext').focus();
        else
            this.domHandler.findSingle(this.el.nativeElement, 'input[readonly]').focus();
    };
    Dropdownp.prototype.bindDocumentClickListener = function () {
        var _this = this;
    ...
    Dropdownp.prototype.unbindDocumentClickListener = function () {
        if (this.documentClickListener) {
            this.documentClickListener();
            this.documentClickListener = null;
        }
    };
    Dropdownp.prototype.ngOnDestroy = function () {
...
], Dropdownp.prototype, "options", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], Dropdownp.prototype, "scrollHeight", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], Dropdownp.prototype, "filter", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], Dropdownp.prototype, "style", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], Dropdownp.prototype, "panelStyle", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], Dropdownp.prototype, "styleClass", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], Dropdownp.prototype, "panelStyleClass", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], Dropdownp.prototype, "disabled", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], Dropdownp.prototype, "readonly", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], Dropdownp.prototype, "autoWidth", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], Dropdownp.prototype, "required", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], Dropdownp.prototype, "editable", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], Dropdownp.prototype, "appendTo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Number)
], Dropdownp.prototype, "tabindex", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], Dropdownp.prototype, "placeholder", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", core_1.EventEmitter)
], Dropdownp.prototype, "onChange", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", core_1.EventEmitter)
], Dropdownp.prototype, "onFocus", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", core_1.EventEmitter)
], Dropdownp.prototype, "onBlur", void 0);
__decorate([
    core_1.ViewChild('container'),
    __metadata("design:type", core_1.ElementRef)
], Dropdownp.prototype, "containerViewChild", void 0);
__decorate([
    core_1.ViewChild('panel'),
    __metadata("design:type", core_1.ElementRef)
], Dropdownp.prototype, "panelViewChild", void 0);
__decorate([
    core_1.ViewChild('itemswrapper'),
    __metadata("design:type", core_1.ElementRef)
], Dropdownp.prototype, "itemsWrapperViewChild", void 0);
__decorate([
    core_1.ViewChild('filter'),
    __metadata("design:type", core_1.ElementRef)
], Dropdownp.prototype, "filterViewChild", void 0);
__decorate([
    core_1.ContentChildren(shared_1.PrimeTemplate),
    __metadata("design:type", core_1.QueryList)
], Dropdownp.prototype, "templates", void 0);
Dropdownp = __decorate([
    core_1.Component({
        selector: 'p-dropdown',
...
exports.Dropdownp = Dropdownp;
var DropdownpModule = (function () {
    function DropdownpModule() {
    }
    return DropdownpModule;
}());
DropdownpModule = __decorate([
    core_1.NgModule({
        imports: [common_1.CommonModule, shared_1.SharedModule],
        exports: [Dropdownp, shared_1.SharedModule],
        declarations: [Dropdownp]
    })
], DropdownpModule);
exports.DropdownpModule = DropdownpModule;
//# sourceMappingURL=dropdownp.js.map
...
export const DROPDOWN_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => Dropdownp),
  multi: true
};
...
export class Dropdownp implements OnInit,AfterViewInit,AfterContentInit,AfterViewChecked,DoCheck,OnDestroy,ControlValueAccessor {
...
@NgModule({
    ...
    exports: [Dropdownp,SharedModule],
    declarations: [Dropdownp]
})
export class DropdownpModule { }

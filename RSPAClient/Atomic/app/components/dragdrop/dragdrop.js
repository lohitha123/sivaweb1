...
], Draggable.prototype, "draggable", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
...
var Droppable = (function () {
    ...
    Droppable.prototype.allowDrop = function (event) {
        ...
        //    return true;
        //}
        //if (dragScope == 'lstPrintRepdetailslist3' || dragScope == 'lstPrintRepdetailslist8') {
        //    if (this.scope != 'lstPrintRepdetailslist2' && this.scope != 'lstPrintRepdetailslist4') {
        //        return true;
        //    }
        //}
        //if (dragScope == 'lstPrintRepdetailslist2' || dragScope == 'lstPrintRepdetailslist4') {
        //    if (this.scope != 'lstPrintRepdetailslist3' && this.scope != 'lstPrintRepdetailslist8') {
        //        return true;
        //    }
        //}
        if (dragScope == 'lstPrintRepHeaderColumnsRight' || dragScope == 'lstPrintRepHeaderColumnsLeft') {
            if (this.scope != 'lstPrintRepDetailColumnsMain' && this.scope != 'lstPrintRepDetailColumnsRight') {
                return true;
            }
        }
        if (dragScope == 'lstPrintRepDetailColumnsMain' || dragScope == 'lstPrintRepDetailColumnsRight') {
            if (this.scope != 'lstPrintRepHeaderColumnsRight' && this.scope != 'lstPrintRepHeaderColumnsLeft') {
                return true;
            }
        }

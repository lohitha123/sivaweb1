...
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], AccordionTab.prototype, "icon", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
    ...
    core_1.Component({
        ...
        animations: [
            core_1.trigger('tabContent', [
                ...
                core_1.transition('visible => hidden', core_1.animate('500ms cubic-bezier(0.86, 0, 0.07, 1)')),
                core_1.transition('hidden => visible', core_1.animate('500ms cubic-bezier(0.86, 0, 0.07, 1)'))
            ])
        ]
    }),

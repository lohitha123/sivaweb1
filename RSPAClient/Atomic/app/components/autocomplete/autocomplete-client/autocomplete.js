...
var AutoCompleteModuleClient = (function () {
    function AutoCompleteModuleClient() {
    }
    return AutoCompleteModuleClient;
}());
AutoCompleteModuleClient = __decorate([
    core_1.NgModule({
...
], AutoCompleteModuleClient);
exports.AutoCompleteModuleClient = AutoCompleteModuleClient;

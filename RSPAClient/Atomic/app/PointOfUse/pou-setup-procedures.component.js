...
var SetupProceduresComponent = (function () {
    function SetupProceduresComponent(dataservice) {
        var _this = this;
        ...
        this.dataservice.getsetupProcedures().then(function (countries) { _this.sales = countries; });
    }
    ...
    SetupProceduresComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;

...
var ReleaseCasesComponent = (function () {
    function ReleaseCasesComponent(dataservice) {
    ...
    ReleaseCasesComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getpouRelesecase().then(function (countries) { _this.sales = countries; });
    };
    ReleaseCasesComponent.prototype.add = function () {
        this.form = true;
        this.editform = false;
        this.page = false;
        this.pop = false;
    };
    ReleaseCasesComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    ReleaseCasesComponent.prototype.close = function () {
        this.form = false;
        this.page = true;
        this.pop = true;
        this.editform = false;
...
ReleaseCasesComponent = __decorate([
    core_1.Component({
        templateUrl: './app/PointOfUse/pou-release-cases.component.html',

...
var ManageParLocationComponent = (function () {
    function ManageParLocationComponent(dataservice) {
    ...
    ManageParLocationComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getpouManageparLoc().then(function (countries) { _this.sales = countries; });
    };
    ManageParLocationComponent.prototype.add = function () {
        var _this = this;
        this.page = false;
        this.pop = false;
        this.table = true;
    ...
    ManageParLocationComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    ManageParLocationComponent.prototype.close = function () {
        var _this = this;
        this.page = true;
        this.pop = true;
        this.table = false;
...
//# sourceMappingURL=pou-manage-par-location.component.js.map
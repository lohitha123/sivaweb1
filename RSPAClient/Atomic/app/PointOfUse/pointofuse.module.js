...
var pointofuse_routing_module_1 = require("./pointofuse-routing.module");
...
PointOfUseModule = __decorate([
    core_1.NgModule({
        imports: [
            pointofuse_routing_module_1.PointOfUseRoutingModule,
            shared_module_1.SharedModule
        ],
        declarations: [
            pointofuse_component_1.PointOfUseComponent,
            ...
            pou_quanity_on_hand_report_component_1.QuanityOnHandReportComponent,

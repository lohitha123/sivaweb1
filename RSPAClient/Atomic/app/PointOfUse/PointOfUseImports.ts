...
export const PointOfUseImports = [ActivityReportComponent, BackOrderReportComponent, BillOnlyItemMaintenanceComponent,  CaseReviewReportComponent, CaseTrackReportComponent, ChargeReportComponent, CompilanceSummaryReportComponent, ComplianceDetailReportComponent,
    POUCreateOrdersComponent, POUCriticalItemsComponent, DailyUserActivityReportComponent, DashBoardComponent, DepartmentDeviceAllocationComponent, DepartmentLocationAllocationComponent, DepartmentLocationWorkstationAllocationComponent, DepartmentUserAllocationComponent,
    ExpirationTrackingReportComponent, IssuesWOPatientReportComponent, ItemUsageAnalysisReportComponent, ItemUsageReportComponent, LotSerialTrackingReportComponent, LowStockReportComponent, MaintainNonCartItemsComponent, ManageCasesComponent, ManageConsignedItemOrderReportComponent,
    ManageOrdersComponent, ManageParLocationComponent, NonCatalogPurchasesComponent, ParOptimizationReportComponent, PhysicianUsageReportComponent, PostPickQAComponent, PrefCardOptimizationReportComponent, PrefCardPerformanceDetailsComponent, PrefCardPerformanceManagementSummaryComponent,
    PrefCardPerformanceSummaryComponent, PreferenceListsComponent, ProcessParamsComponent, QuanityOnHandReportComponent, ReleaseCasesComponent, ReviewChargesCreditsComponent, SetupCaseComponent,
    SetupDepartmentsComponent, SetupItemAttributesComponent, SetupParLocationsComponent, SetupPhysiciansComponent, SetupProceduresComponent, SetupReasonsComponent, SetupSpecialtyServiceComponent, TransactionHistoryReportComponent, UserParametersComponent ]
...
var SetupReasonsComponent = (function () {
    function SetupReasonsComponent(dataservice) {
        var _this = this;
        ...
        this.dataservice.getsetupReasons().then(function (countries) { _this.sales = countries; });
    }
    SetupReasonsComponent.prototype.go = function () {
    };
    ...
    SetupReasonsComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
...
SetupReasonsComponent = __decorate([
    core_1.Component({
        templateUrl: './app/PointOfUse/pou-setup-reasons.component.html',
...
//# sourceMappingURL=pou-setup-reasons.component.js.map
...
exports.PointOfUseImports = [pou_activity_report_component_1.ActivityReportComponent, pou_back_order_report_component_1.BackOrderReportComponent, pou_bill_only_item_maintenance_component_1.BillOnlyItemMaintenanceComponent, pou_case_review_report_component_1.CaseReviewReportComponent, pou_case_track_report_component_1.CaseTrackReportComponent, pou_charge_report_component_1.ChargeReportComponent, pou_compilance_summary_report_component_1.CompilanceSummaryReportComponent, pou_compliance_detail_report_component_1.ComplianceDetailReportComponent,
    pou_create_orders_component_1.POUCreateOrdersComponent, pou_critical_items_component_1.POUCriticalItemsComponent, pou_daily_user_activity_report_component_1.DailyUserActivityReportComponent, pou_dashboard_component_1.DashBoardComponent, pou_department_device_allocation_component_1.DepartmentDeviceAllocationComponent, pou_department_loaction_allocation_component_1.DepartmentLocationAllocationComponent, pou_department_location_workstation_allocation_component_1.DepartmentLocationWorkstationAllocationComponent, pou_department_user_allocation_component_1.DepartmentUserAllocationComponent,
    pou_expiration_tracking_report_component_1.ExpirationTrackingReportComponent, pou_issues_wo_patient_report_component_1.IssuesWOPatientReportComponent, pou_item_usage_analysis_report_component_1.ItemUsageAnalysisReportComponent, pou_item_usage_report_component_1.ItemUsageReportComponent, pou_lotserial_tracking_report_component_1.LotSerialTrackingReportComponent, pou_low_stock_report_component_1.LowStockReportComponent, pou_maintain_non_cart_items_component_1.MaintainNonCartItemsComponent, pou_manage_cases_component_1.ManageCasesComponent, pou_manage_cosigned_item_order_report_componenet_1.ManageConsignedItemOrderReportComponent,
    pou_manage_orders_component_1.ManageOrdersComponent, pou_manage_par_location_component_1.ManageParLocationComponent, pou_non_catalog_purchases_component_1.NonCatalogPurchasesComponent, pou_par_optimization_report_component_1.ParOptimizationReportComponent, pou_physician_usage_report_component_1.PhysicianUsageReportComponent, pou_post_pick_qa_component_1.PostPickQAComponent, pou_pref_card_optimization_report_component_1.PrefCardOptimizationReportComponent, pou_pref_card_performance_details_component_1.PrefCardPerformanceDetailsComponent, pou_pref_card_performance_management_summary_component_1.PrefCardPerformanceManagementSummaryComponent,
    pou_pref_card_performance_summary_component_1.PrefCardPerformanceSummaryComponent, pou_preference_lists_component_1.PreferenceListsComponent, pou_process_parameters_component_1.ProcessParamsComponent, pou_quanity_on_hand_report_component_1.QuanityOnHandReportComponent, pou_release_cases_component_1.ReleaseCasesComponent, pou_review_charges_credits_component_1.ReviewChargesCreditsComponent, pou_setup_case_component_1.SetupCaseComponent,
    pou_setup_departments_component_1.SetupDepartmentsComponent, pou_setup_item_attributes_component_1.SetupItemAttributesComponent, pou_setup_par_locations_component_1.SetupParLocationsComponent, pou_setup_physicians_component_1.SetupPhysiciansComponent, pou_setup_procedures_component_1.SetupProceduresComponent, pou_setup_reasons_component_1.SetupReasonsComponent, pou_setup_specialty_services_component_1.SetupSpecialtyServiceComponent, pou_transaction_history_report_component_1.TransactionHistoryReportComponent, pou_user_parameters_component_1.UserParametersComponent];
//# sourceMappingURL=PointOfUseImports.js.map
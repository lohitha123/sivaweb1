...
var ManageCasesComponent = (function () {
    function ManageCasesComponent(dataservice) {
    ...
    ManageCasesComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
    ...
    ManageCasesComponent.prototype.tbl = function () {
        var _this = this;
        this.form = false;
        this.editform = false;
        this.page = false;
    ...
    ManageCasesComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    ManageCasesComponent.prototype.save = function () {
        this.editform = false;
    };
...
ManageCasesComponent = __decorate([
    core_1.Component({
        templateUrl: './app/PointOfUse/pou-manage-cases.component.html',

...
var DepartmentDeviceAllocationComponent = (function () {
    function DepartmentDeviceAllocationComponent(dataservice) {
        var _this = this;
    ...
    DepartmentDeviceAllocationComponent.prototype.go = function () {
        var _this = this;
        this.table = true;
        this.page = false;
    ...
    DepartmentDeviceAllocationComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    ...
    DepartmentDeviceAllocationComponent.prototype.back = function () {
        var _this = this;
        this.table = false;
        this.page = true;
        this.dataservice.getddAllocation().then(function (countries) { _this.sales = countries; });

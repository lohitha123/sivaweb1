...
var SetupCaseComponent = (function () {
    function SetupCaseComponent(dataservice) {
        var _this = this;
        ...
        this.dataservice.getpousetupcases().then(function (countries) { _this.sales = countries; });
    }
    SetupCaseComponent.prototype.go = function () {
        //this.pop = !this.pop;

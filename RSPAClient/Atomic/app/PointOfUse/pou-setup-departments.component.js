...
var SetupDepartmentsComponent = (function () {
    function SetupDepartmentsComponent(dataservice) {
        var _this = this;
    ...
    SetupDepartmentsComponent.prototype.add = function () {
        this.form = true;
        this.editform = false;
        this.page = false;
        this.pop = false;
    };
    SetupDepartmentsComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
...
SetupDepartmentsComponent = __decorate([
    core_1.Component({
        templateUrl: './app/PointOfUse/pou-setup-departments.component.html',

...
var ShipToIdAllocationForDeliveryOfStockItemsComponent = (function () {
    function ShipToIdAllocationForDeliveryOfStockItemsComponent(dataservice) {
    ...
    ShipToIdAllocationForDeliveryOfStockItemsComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getdelShiptoidallocdel().then(function (countries) { _this.sales = countries; });
    };
    ShipToIdAllocationForDeliveryOfStockItemsComponent.prototype.add = function () {
        this.form = true;
        this.editform = false;
        this.page = false;
        this.pop = false;
    };
    ShipToIdAllocationForDeliveryOfStockItemsComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    ShipToIdAllocationForDeliveryOfStockItemsComponent.prototype.close = function () {
        this.form = false;
        this.page = true;
        this.pop = true;
        this.editform = false;
...
ShipToIdAllocationForDeliveryOfStockItemsComponent = __decorate([
    core_1.Component({
        templateUrl: './app/Deliver/deliver-shiptoid-allocation-for-delivery-of-stock-items.component.html',

...
var AllocateBusinessUnitsComponent = (function () {
    function AllocateBusinessUnitsComponent(dataservice) {
    ...
    AllocateBusinessUnitsComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getallocateBunits().then(function (countries) { _this.sales = countries; });
    };
...
//# sourceMappingURL=ptwy-allocate-business-units.component.js.map
...
var ReviewCountsComponent = (function () {
    function ReviewCountsComponent(dataservice) {
    ...
    ReviewCountsComponent.prototype.go = function () {
        var _this = this;
        this.pop = !this.pop;
        this.dataservice.getcyclReviewCount().then(function (countries) { _this.sales = countries; });
    };

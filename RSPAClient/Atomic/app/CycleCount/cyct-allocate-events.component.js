...
var AllocateEventsComponent = (function () {
    function AllocateEventsComponent(dataservice) {
    ...
    AllocateEventsComponent.prototype.go = function () {
        var _this = this;
        this.dataservice.getAllocateEvents().then(function (countries) { _this.sales = countries; });
        this.pop = !this.pop;
    };
    AllocateEventsComponent.prototype.add = function () {
        this.form = true;
        this.editform = false;
        this.page = false;
        this.pop = false;
    };
    AllocateEventsComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    AllocateEventsComponent.prototype.close = function () {
        this.form = false;
        this.page = true;
        this.pop = true;
        this.editform = false;
...
AllocateEventsComponent = __decorate([
    core_1.Component({
        templateUrl: './app/CycleCount/cyct-allocate-events.component.html',

...
var CheckInComponent = (function () {
    function CheckInComponent(dataservice) {
    ...
    CheckInComponent.prototype.go = function () {
        this.pop = !this.pop;
        // this.dataservice.getpouCriticalItems().then(countries => { this.sales = countries; });
    };
    CheckInComponent.prototype.add = function () {
        this.form = true;
        this.editform = false;
        this.page = false;
        this.pop = false;
    };
    CheckInComponent.prototype.tbl = function () {
        this.form = false;
        this.editform = false;
        this.page = false;
        this.pop = false;
    ...
    CheckInComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    CheckInComponent.prototype.save = function () {
        this.editform = false;
    };
    CheckInComponent.prototype.close = function () {
        this.form = false;
        this.page = true;
        this.pop = true;
        this.editform = false;
...
//# sourceMappingURL=tkit-check-in.component.js.map
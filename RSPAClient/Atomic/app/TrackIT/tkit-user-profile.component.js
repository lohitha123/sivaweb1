...
var UserprofileComponent = (function () {
    ...
    UserprofileComponent.prototype.go = function () {
        this.pop = !this.pop;
    ...
    UserprofileComponent.prototype.tbl = function () {
        this.form = false;
        this.editform = false;
        this.page = false;
        this.pop = false;
...
UserprofileComponent = __decorate([
    core_1.Component({
        templateUrl: './app/TrackIT/tkit-user-profile.component.html',
        providers: [datatableservice_1.datatableservice],
    }),
    __metadata("design:paramtypes", [datatableservice_1.datatableservice])
], UserprofileComponent);
exports.UserprofileComponent = UserprofileComponent;
//# sourceMappingURL=tkit-user-profile.component.js.map
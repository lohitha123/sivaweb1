...
var CheckOutComponent = (function () {
    ...
    CheckOutComponent.prototype.go = function () {
        this.pop = !this.pop;
    ...
    CheckOutComponent.prototype.tbl = function () {
        this.form = false;
        this.editform = false;
        this.page = false;
        this.pop = false;
    ...
    CheckOutComponent.prototype.edit = function () {
        this.editform = true;
        this.form = false;
        this.page = false;
        this.pop = false;
    };
    CheckOutComponent.prototype.save = function () {
        this.editform = false;
    };
...
CheckOutComponent = __decorate([
    core_1.Component({
        templateUrl: './app/TrackIT/tkit-check-out.component.html',

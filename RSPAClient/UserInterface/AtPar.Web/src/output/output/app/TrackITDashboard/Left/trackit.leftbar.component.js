...
var TrackITLeftBarComponent = (function () {
    function TrackITLeftBarComponent(spinnerService, router) {
        this.spinnerService = spinnerService;
        this.router = router;
        this.sideMenus = [];
    }
    TrackITLeftBarComponent.prototype.ngOnInit = function () {
        this.getSideMenus();
    };
    TrackITLeftBarComponent.prototype.getSideMenus = function () {
        return __awaiter(this, void 0, void 0, function () {
            var menu;
            return __generator(this, function (_a) {
                try {
                    this.sideMenus = [];
                    menu = new routepath_1.Menus();
    ...
    TrackITLeftBarComponent.prototype.onMenuClick = function (menu) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    TrackITLeftBarComponent.prototype.OnDestroy = function () {
    };
    TrackITLeftBarComponent = __decorate([
        core_1.Component({
            selector: 'trackit-leftbar-cmp',
            templateUrl: 'trackit.leftbar.component.html',
            providers: []
        }),
        __metadata("design:paramtypes", [event_spinner_service_1.SpinnerService,
            router_1.Router])
    ], TrackITLeftBarComponent);
    return TrackITLeftBarComponent;
}());
exports.TrackITLeftBarComponent = TrackITLeftBarComponent;
//# sourceMappingURL=trackit.leftbar.component.js.map
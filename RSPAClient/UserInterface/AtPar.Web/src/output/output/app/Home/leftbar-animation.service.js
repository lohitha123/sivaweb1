...
var LeftBarAnimationService = (function () {
    function LeftBarAnimationService() {
        ...
        this.emitChangeReportActiveMenu = new Subject_1.Subject();
        ...
        this.changeReportsActiveMenu$ = this.emitChangeReportActiveMenu.asObservable();
    ...
    LeftBarAnimationService.prototype.emitChangeReportaActiveMenu = function (change) {

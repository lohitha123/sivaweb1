...
(function (ConfigData) {
    ...
    (function (ConfigurationManager_Tabs) {
        ...
        ConfigurationManager_Tabs[ConfigurationManager_Tabs["REPORTSCONFIGDBCONNECTION"] = 12] = "REPORTSCONFIGDBCONNECTION";
        ConfigurationManager_Tabs[ConfigurationManager_Tabs["REPORTSDBCONNECTION"] = 13] = "REPORTSDBCONNECTION";
    ...
    var REPORTSCONFIGDBCONNECTION;
    (function (REPORTSCONFIGDBCONNECTION) {
        //''' <summary>
        //''' Database type e.g. SQLSERVER
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["DATABASE"] = 0] = "DATABASE";
        //''' <summary>
        //''' Userid of the DB user
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["USERID"] = 1] = "USERID";
        //''' <summary>
        //''' AtPar Encrypted Password
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["PASSWORD"] = 2] = "PASSWORD";
        //''' <summary>
        //''' Database name e.g. ATPAR_MASTER
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["DATASOURCE"] = 3] = "DATASOURCE";
        //''' <summary>
        //''' Server FQDN or IP or instance name
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["SERVER"] = 4] = "SERVER";
        //''' <summary>
        //''' Driver String e.g. {SQL Server}
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["DRIVER"] = 5] = "DRIVER";
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["STARTER_API_DATABASE"] = 6] = "STARTER_API_DATABASE";
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["STARTER_API_DATASOURCE"] = 7] = "STARTER_API_DATASOURCE";
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["STARTER_API_USERID"] = 8] = "STARTER_API_USERID";
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["STARTER_API_PASSWORD"] = 9] = "STARTER_API_PASSWORD";
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["STARTER_API_SERVER"] = 10] = "STARTER_API_SERVER";
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["STARTER_API_DRIVER"] = 11] = "STARTER_API_DRIVER";
        REPORTSCONFIGDBCONNECTION[REPORTSCONFIGDBCONNECTION["MT_DRIVER"] = 12] = "MT_DRIVER";
    })(REPORTSCONFIGDBCONNECTION = ConfigData.REPORTSCONFIGDBCONNECTION || (ConfigData.REPORTSCONFIGDBCONNECTION = {}));
    var REPORTSDBCONNECTION;
    (function (REPORTSDBCONNECTION) {
        //''' <summary>
        //''' Database type e.g. SQLSERVER
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSDBCONNECTION[REPORTSDBCONNECTION["DATABASE"] = 0] = "DATABASE";
        //''' <summary>
        //''' Userid of the DB user
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSDBCONNECTION[REPORTSDBCONNECTION["USERID"] = 1] = "USERID";
        //''' <summary>
        //''' AtPar Encrypted Password
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSDBCONNECTION[REPORTSDBCONNECTION["PASSWORD"] = 2] = "PASSWORD";
        //''' <summary>
        //''' Database name e.g. ATPAR_MASTER
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSDBCONNECTION[REPORTSDBCONNECTION["DATASOURCE"] = 3] = "DATASOURCE";
        //''' <summary>
        //''' Server FQDN or IP or instance name
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSDBCONNECTION[REPORTSDBCONNECTION["SERVER"] = 4] = "SERVER";
        //''' <summary>
        //''' Driver String e.g. {SQL Server}
        //''' </summary>
        //''' <remarks></remarks>
        REPORTSDBCONNECTION[REPORTSDBCONNECTION["DRIVER"] = 5] = "DRIVER";
    })(REPORTSDBCONNECTION = ConfigData.REPORTSDBCONNECTION || (ConfigData.REPORTSDBCONNECTION = {}));

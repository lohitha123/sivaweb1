...
var ExportDashboardViewerComponent = (function () {
    function ExportDashboardViewerComponent(router, activatedRoute) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.currentUserContext = {};
    }
    ExportDashboardViewerComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    ExportDashboardViewerComponent = __decorate([
        core_1.Component({
            templateUrl: 'export.dashboardviewer.html'
        }),
        __metadata("design:paramtypes", [router_1.Router, router_1.ActivatedRoute])
    ], ExportDashboardViewerComponent);
    return ExportDashboardViewerComponent;
}());
exports.ExportDashboardViewerComponent = ExportDashboardViewerComponent;
//# sourceMappingURL=export.dashboardviewercomponent.js.map
...
var AutoComplete = (function () {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], AutoComplete.prototype, "isfocus", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], AutoComplete.prototype, "id", void 0);
    __decorate([
        core_1.ViewChild('in'),
...
var AutoCompleteServerModule = (function () {
    function AutoCompleteServerModule() {
    }
    AutoCompleteServerModule = __decorate([
        core_1.NgModule({
    ...
    return AutoCompleteServerModule;
}());
exports.AutoCompleteServerModule = AutoCompleteServerModule;
//# sourceMappingURL=autocomplete-server.js.map
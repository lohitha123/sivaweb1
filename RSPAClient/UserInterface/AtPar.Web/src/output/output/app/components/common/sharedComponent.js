...
var SharedPrimeModule = (function () {
    function SharedPrimeModule() {
    }
    SharedPrimeModule = __decorate([
        core_1.NgModule({
    ...
    return SharedPrimeModule;
}());
exports.SharedPrimeModule = SharedPrimeModule;

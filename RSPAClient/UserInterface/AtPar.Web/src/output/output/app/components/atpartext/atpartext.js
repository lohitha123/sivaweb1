...
var AtParTextComponent = (function () {
    ...
    AtParTextComponent.prototype.handelInput = function (e) {
        ...
        if (this.validationrules != null && this.validationrules != undefined && this.validationrules.length > 0) {
            ...
            if (this.validateDecimal != null) {
                ...
                else if (charCode == 46 && this.value.toString().indexOf('.') !== -1) {
            ...
            //numeric with appending 0 before
            this.validateNumberWithDot = this.validationrules.filter(function (x) { return x.ValidationType == "numeric_dot_initial"; })[0];
            if (this.validateNumberWithDot != null) {
                e = (e) ? e : window.event;
                if (this.value == undefined || this.value == null) {
                    this.value = "";
                }
                var charCode = (e.which) ? e.which : e.keyCode;
                if (charCode == 8) {
                    this.validateNumberWithDot.status = true;
                    //return true;
                }
                else if (charCode == 46 && this.value.toString().indexOf('.') !== -1) {
                    this.validateNumberWithDot.status = false;
                    return false;
                }
                else if (charCode > 31 && charCode != 46 && (charCode < 48 || charCode > 57)) {
                    this.validateNumberWithDot.status = false;
                ...
                else if (charCode == 46 && this.value == "") {
    ...
    AtParTextComponent.prototype.onKey = function (event) {
        ...
        this.validatenumbers = this.validationrules.filter(function (x) { return x.ValidationType == "numeric_dot"; })[0];
        if (this.validatenumbers != null) {
            if (Validators_1.regExpValidator("numeric_dot", this.paramval)) {
                this.showerror = false;
                this.validatenumbers.status = true;
            }
            else {
        ...
        //validating decimal for appending 0
        this.validatenumberswithZero = this.validationrules.filter(function (x) { return x.ValidationType == "numeric_dot_initial"; })[0];
        if (this.validatenumberswithZero != null) {
            if (Validators_1.regExpValidator("numeric_dot_initial", this.paramval)) {
                this.showerror = false;
                this.validatenumberswithZero.status = true;
            }
            else {
                if (this.paramval == "") {
                    this.validatenumberswithZero.status = true;
                    ...
                    this.showerror = true;
                    this.errormessage = "Invalid";
                    this.validatenumberswithZero.status = false;
                }
                this.Emitbeforereturn();
                return;
            }
    ...
    AtParTextComponent.prototype.onCutPaste = function (event) {
    ...
    ], AtParTextComponent.prototype, "disabled", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ...
    ], AtParTextComponent.prototype, "title", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], AtParTextComponent.prototype, "convertToUpper", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ], AtParTextComponent.prototype, "onchange", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], AtParTextComponent.prototype, "placeholder", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], AtParTextComponent.prototype, "style", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ...
    ], AtParTextComponent.prototype, "onEnter", void 0);

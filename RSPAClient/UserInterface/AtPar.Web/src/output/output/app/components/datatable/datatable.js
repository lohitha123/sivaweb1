...
var sharedComponent_2 = require("../common/sharedComponent");
...
var RowExpansionLoader = (function () {
    ...
    RowExpansionLoader = __decorate([
        core_1.Component({
            selector: 'atpar-rowexpansionloader',
            template: ""
        }),
...
var ScrollableView = (function () {
    ...
    __decorate([
        core_1.Input("atpar-scrollableview"),
        __metadata("design:type", Array)
...
var DataTable = (function () {
    function DataTable(el, domHandler, differs, document, renderer, changeDetector) {
        this.el = el;
        this.domHandler = domHandler;
    ...
    DataTable.prototype.paginate = function (event) {
        ...
        sessionStorage.setItem("RecordsPerPage", JSON.stringify(this.rows));
        if (this.lazy) {
        ...
        if (this.expandedRows != null && this.expandedRows.length > 0) {
            for (var i = 0; i <= this.expandedRows.length; i++) {
                var expandedRowIndex = this.findExpandedRowIndex(this.expandedRows[i]);
                if (expandedRowIndex != -1) {
                    this.expandedRows.splice(expandedRowIndex, 1);
                    this.onRowCollapse.emit({
                        originalEvent: event,
                        data: this.expandedRows[i]
                    });
                    i--;
                }
            }
    ...
    DataTable.prototype.updateDataToRender = function (datasource) {
        if (this.paginator && datasource) {
            ...
            sessionStorage.setItem("Recordsstartindex", JSON.stringify(this.first));
            for (var i = startIndex; i < (startIndex + this.rows); i++) {
                sessionStorage.setItem("RecordsEndindex", JSON.stringify(startIndex + this.rows));
    ...
    DataTable.prototype._filter = function () {
        ...
        this.filteredData.emit(this.filteredValue);
        this.onFilter.emit({
    ...
    DataTable.prototype.onCutPaste = function (event, field, matchMode) {
        var copiedvalue = event.clipboardData.getData("text");
        this.onFilterKeyup(copiedvalue, field, matchMode);
    };
    ...
    DataTable.prototype.isRowExpanded = function (row) {
        return row.isExpander == null ? this.findExpandedRowIndex(row) != -1 : row.isExpander && this.findExpandedRowIndex(row) != -1;
    };
    DataTable.prototype.isEnable = function (row) {
        return row.isExpander == null ? true : row.isExpander;
    };
    ...
    DataTable.prototype.getRowStyleClass = function (rowData, rowIndex) {
        ...
        if (rowData.rowClsStyle != null) {
            styleClass += ' ' + rowData.rowClsStyle;
        }
    ...
    __decorate([
        core_1.ContentChild(sharedComponent_2.Header),
        __metadata("design:type", Object)
    ], DataTable.prototype, "header", void 0);
    __decorate([
        core_1.ContentChild(sharedComponent_2.Footer),
        __metadata("design:type", Object)
    ...
    __decorate([
        core_1.ContentChildren(sharedComponent_2.PrimeTemplate),
        __metadata("design:type", core_1.QueryList)
    ], DataTable.prototype, "templates", void 0);
    __decorate([
        core_1.ContentChildren(sharedComponent_2.Column),
        __metadata("design:type", core_1.QueryList)
    ], DataTable.prototype, "cols", void 0);
    __decorate([
        core_1.ContentChild(sharedComponent_2.HeaderColumnGroup),
        __metadata("design:type", sharedComponent_2.HeaderColumnGroup)
    ], DataTable.prototype, "headerColumnGroup", void 0);
    __decorate([
        core_1.ContentChild(sharedComponent_2.FooterColumnGroup),
        __metadata("design:type", sharedComponent_2.FooterColumnGroup)
    ], DataTable.prototype, "footerColumnGroup", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], DataTable.prototype, "filteredData", void 0);
    DataTable = __decorate([
        core_1.Component({
            selector: 'atpar-datatable',
            templateUrl: 'datatable.html',
            providers: [domhandler_1.DomHandler]
        }),
        __param(3, core_1.Inject(platform_browser_1.DOCUMENT)),
        __metadata("design:paramtypes", [core_1.ElementRef, domhandler_1.DomHandler, core_1.IterableDiffers, Object, core_1.Renderer, core_1.ChangeDetectorRef])
    ], DataTable);
    return DataTable;
}());
exports.DataTable = DataTable;
var AtParDataTableModule = (function () {
    function AtParDataTableModule() {
    }
    AtParDataTableModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, sharedComponent_1.SharedPrimeModule, paginator_1.PaginatorModule, forms_1.FormsModule, inputtext_1.InputTextModule],
            exports: [DataTable, sharedComponent_1.SharedPrimeModule],
    ...
    return AtParDataTableModule;
}());
exports.AtParDataTableModule = AtParDataTableModule;

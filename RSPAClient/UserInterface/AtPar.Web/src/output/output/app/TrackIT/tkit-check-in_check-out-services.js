...
var CheckInCheckOutItemsServices = (function () {
    ...
    CheckInCheckOutItemsServices.prototype.getPatientList = function () {
        return this.httpservice.get({
    ...
    CheckInCheckOutItemsServices.prototype.getItemsForAutoSearch = function (eqType, eqpInidcator) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.httpservice.getSync({
    ...
    CheckInCheckOutItemsServices.prototype.getEquipmentType = function (userID) {
    ...
    CheckInCheckOutItemsServices.prototype.getEquipmentItems = function (eqpType, itemDescr) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.httpservice.getSync({
    ...
    CheckInCheckOutItemsServices.prototype.getItems = function (itemId) {
        return this.httpservice.get({
    ...
    CheckInCheckOutItemsServices.prototype.getPatients = function (itemID) {
        return this.httpservice.getSync({
            apiMethod: "/api/CreateRequest/GetPatientList",
            params: {
                "itemID": itemID
...
//# sourceMappingURL=tkit-check-in_check-out-services.js.map
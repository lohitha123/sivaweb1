...
export const CALENDAR_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => DoubleCalendar),
    multi: true
};
...
export class DoubleCalendar implements AfterViewInit, OnInit, OnDestroy, ControlValueAccessor {
    ...
    createMonth(month: number, year: number, type: String) {
    ...
    createNextMonth(month: number, year: number, type: String) {
        this.dates1 = [];
    ...
    onCurrentMonthDropdownChange(m: string) {
    ...
    onNextMonthDropdownChange(m: string) {
    ...
    onCurrentYearDropdownChange(y: string) {
    ...
    onNextYearDropdownChange(y: string) {
...
@NgModule({
    ...
    exports: [DoubleCalendar, ButtonModule, InputTextModule],
    declarations: [DoubleCalendar]
})
export class DoubleCalendarModule { }
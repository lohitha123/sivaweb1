...
import { Header, SharedPrimeModule } from '../common/sharedComponent';
...
export class MailDialog implements AfterViewInit, AfterViewChecked, OnDestroy {
...
@NgModule({
    ...
    exports: [MailDialog, SharedPrimeModule],

...
import {
    ...
    Output, SimpleChange, EventEmitter, ContentChild, ContentChildren, Renderer, IterableDiffers, QueryList, TemplateRef, ChangeDetectorRef, Inject, forwardRef, CUSTOM_ELEMENTS_SCHEMA
} from '@angular/core';
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms'
import { SharedPrimeModule } from '../common/sharedComponent';
import { PaginatorModule } from '../paginator/paginator';
import { InputTextModule } from '../inputtext/inputtext';
import { Column, Header, Footer, HeaderColumnGroup, FooterColumnGroup, PrimeTemplate } from '../common/sharedComponent';
...
export class ColumnHeaders {
    ...
    @Input("atpar-columnheaders") columns: Column[];
}
...
export class ScrollableView implements AfterViewInit, OnDestroy {
    ...
    @Input("atpar-scrollableview") columns: Column[];
...
export class DataTable implements AfterViewChecked, AfterViewInit, AfterContentInit, OnInit, DoCheck, OnDestroy {
    ...
    constructor(public el: ElementRef, public domHandler: DomHandler, differs: IterableDiffers, @Inject(DOCUMENT) private document,
    ...
    paginate(event) {
        ...
        if (this.expandedRows != null && this.expandedRows.length > 0) {
            for (var i = 0; i <= this.expandedRows.length; i++){
                let expandedRowIndex = this.findExpandedRowIndex(this.expandedRows[i]);
    ...
    onCutPaste(event, field, matchMode)
    {
...
@NgModule({
    imports: [CommonModule, SharedPrimeModule, PaginatorModule, FormsModule, InputTextModule],
    exports: [DataTable, SharedPrimeModule],
...
export class AtParDataTableModule { }

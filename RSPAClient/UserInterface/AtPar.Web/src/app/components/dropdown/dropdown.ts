...
export class Dropdown implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, DoCheck, OnDestroy, ControlValueAccessor {
    ...
    @Input() selectOnKeyPress: boolean = false;
    ...
    public spacekeydownvalue: string;
    ...
    show(panel, container) {
        ...
        if (this.options && this.options.length) {
            ...
            if (this.appendTo)
                ...
                this.domHandler.relativePosition2(panel, container, this.optionL); console.log('hit');
...
@NgModule({
    ...
    exports: [Dropdown, SharedPrimeModule],

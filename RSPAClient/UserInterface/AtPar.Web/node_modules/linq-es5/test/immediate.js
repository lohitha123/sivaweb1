...
describe('Immediate Execution -', function () {
    ...
    it('Aggregate() - No seed', function () {
        chai_1.assert.equal(55, Linq.From(data_1.simpleArray).Aggregate(function (a, b) { return a + b; }));
    });
    it('Aggregate()', function () {
        chai_1.assert.equal(3628800, Linq.From(data_1.simpleArray).Aggregate(1, function (a, b) { return a * b; }));
    });
    it('Aggregate() - Transform', function () {
        chai_1.assert.equal(1814400, Linq.From(data_1.simpleArray).Aggregate(1, function (a, b) { return a * b; }, function (o) { return o / 2; }));
    });
    // All
    it('All() - True', function () {
        chai_1.assert.isTrue(Linq.From(data_1.oddArray).All(function (b) { return b % 2 == 1; }));
    });
    it('All() - False', function () {
        chai_1.assert.isFalse(Linq.From(data_1.simpleArray).All(function (b) { return b % 2 == 1; }));
    });
    // Any
    ...
    it('Any() - True', function () {
        chai_1.assert.isTrue(Linq.From(data_1.simpleArray).Any(function (i) { return i > 3; }));
    });
    it('Any() - False', function () {
        chai_1.assert.isFalse(Linq.From(data_1.simpleArray).Any(function (i) { return i > data_1.simpleArray.length; }));
    });
    // Average
    ...
    it('Average()', function () {
        chai_1.assert.equal((1 + 2 + 3 + 4) / 4, Linq.From(data_1.jsn).Average(function (o) { return o.id; }));
    });
    // Contains
    ...
    it('Count()', function () {
        chai_1.assert.equal(5, Linq.From(data_1.simpleArray).Count(function (b) { return b % 2 == 1; }));
    });
    // Max
    ...
    it('Max()', function () {
        chai_1.assert.equal(4, Linq.From(data_1.jsn).Max(function (o) { return o.id; }));
    });
    ...
    it('Min()', function () {
        chai_1.assert.equal(1, Linq.From(data_1.jsn).Min(function (o) { return o.id; }));
    });
    ...
    it('ElementAtOrDefault() - Default Function', function () {
        chai_1.assert.isUndefined(Linq.Repeat(function () { }, 3).ElementAtOrDefault(5));
    });
    ...
    it('First()', function () {
        chai_1.assert.equal(6, Linq.From(data_1.simpleArray).First(function (a) { return a > 5; }));
    });
    it('First() - Empty', function () {
        chai_1.assert.throw(function () {
            chai_1.assert.equal(6, Linq.From(data_1.simpleArray).First(function (a) { return a > 50; }));
        });
    });
    // FirstOrDefault
    ...
    it('FirstOrDefault()', function () {
        chai_1.assert.equal(6, Linq.From(data_1.simpleArray).FirstOrDefault(function (a) { return a > 5; }));
    });
    it('FirstOrDefault() - Empty', function () {
        chai_1.assert.doesNotThrow(function () {
            chai_1.assert.equal(0, Linq.From(data_1.simpleArray).FirstOrDefault(function (a) { return a > 50; }));
        });
    });
    // Last
    ...
    it('Last()', function () {
        chai_1.assert.equal(4, Linq.From(data_1.simpleArray).Last(function (a) { return a < 5; }));
    });
    it('Last() - Empty', function () {
        chai_1.assert.throw(function () {
            Linq.From(data_1.simpleArray).Last(function (a) { return a > 50; });
        });
    });
    // LastOrDefault
    ...
    it('LastOrDefault()', function () {
        chai_1.assert.equal(4, Linq.From(data_1.simpleArray).LastOrDefault(function (a) { return a < 5; }));
    });
    it('LastOrDefault() - Empty', function () {
        chai_1.assert.doesNotThrow(function () {
            chai_1.assert.equal(0, Linq.From(data_1.simpleArray).LastOrDefault(function (a) { return a > 50; }));
        });
    });
    // SequenceEqual
    ...
    it('Single()', function () {
        chai_1.assert.equal(2, Linq.From(data_1.simpleArray).Single(function (a) { return a == 2; }));
    });
    it('Single() - Empty', function () {
        chai_1.assert.throw(function () {
            Linq.From(data_1.simpleArray).Single(function (a) { return a > 15; });
        });
    });
    it('Single() - More than one', function () {
        chai_1.assert.throw(function () {
            Linq.From(data_1.simpleArray).Single(function (a) { return a > 5; });
        });
    });
    // SingleOrDefault
    ...
    it('SingleOrDefault()', function () {
        chai_1.assert.equal(2, Linq.From(data_1.simpleArray).SingleOrDefault(function (a) { return a == 2; }));
    });
    it('SingleOrDefault() - Empty', function () {
        chai_1.assert.equal(0, Linq.From(data_1.simpleArray).SingleOrDefault(function (a) { return a == 20; }));
    });
    it('SingleOrDefault() - More than one', function () {
        chai_1.assert.Throw(function () {
            Linq.From(data_1.simpleArray).SingleOrDefault(function (a) { return a > 5; });
        });
    });
    // Sum
    ...
    it('Sum()', function () {
        chai_1.assert.equal(10, Linq.From(data_1.jsn).Sum(function (o) { return o.id; }));
    });
    // ToArray
    it('ToArray()', function () {
    ...
    it('ToMap() - No Selector', function () {
        chai_1.assert.equal(data_1.jsn[0], Linq.From(data_1.jsn).ToMap(function (o) { return o.id; }).get(1));
    });
    it('ToMap()', function () {
        chai_1.assert.equal(data_1.jsn[0].name, Linq.From(data_1.jsn).ToMap(function (k) { return k.id; }, function (o) { return o.name; }).get(1));
    });
    it('ToDictionary() - No Selector', function () {
        chai_1.assert.equal(data_1.jsn[0], Linq.From(data_1.jsn).ToDictionary(function (o) { return o.id; }).get(1));
    });
    it('ToDictionary()', function () {
        chai_1.assert.equal(data_1.jsn[0].name, Linq.From(data_1.jsn).ToDictionary(function (k) { return k.id; }, function (o) { return o.name; }).get(1));
    });
});

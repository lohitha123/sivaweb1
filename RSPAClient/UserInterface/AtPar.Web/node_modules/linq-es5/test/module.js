...
describe('Module Interface -', function () {
    it('All methods are supported', function () {
        chai_1.assert.isNotNull(Enumerable.from(simpleArray));
        chai_1.assert.isNotNull(Enumerable.From(simpleArray));
        chai_1.assert.isNotNull(Enumerable.asEnumerable(simpleArray));
        chai_1.assert.isNotNull(Enumerable.Range(0, 1));
        chai_1.assert.isNotNull(Enumerable.Repeat(0, 1));
    });
    it('Module\'s default', function () {
        chai_1.assert.isNotNull(linq_1.default(simpleArray));
    });
    it('Range()', function () {
    ...
    it('Range() - Source', function () {
        var array = Enumerable.Range(1, 100)
            .Where(function (o) { return o % 2 == 1; })
            .ToArray();
        chai_1.assert.equal(array.length, 50);
        chai_1.assert.equal(Enumerable.Range(0, 15).Where(function (o) { return o % 2 == 1; }).Count(), 7);
    });

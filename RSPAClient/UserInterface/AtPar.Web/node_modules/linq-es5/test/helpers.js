...
var Helper = require("../lib/utilities");
...
describe("Helpers - ", function () {
    ...
    it('getKeys() - Selector', function () {
        var keys = Helper.getKeys(data, function (e) { return e.id; });
    });
    ...
    it('getKeyedMap', function () {
        var result = Helper.getKeyedMap(data_1.pets, function (e) { return e.Owner; }, function (e) { return e.Name; });
        chai_1.assert.equal(result.size, 3);
        var resultFast = Helper.getKeyedMapFast(data_1.pets, function (e) { return e.Owner; });
